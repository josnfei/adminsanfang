        ...
        methods: {
            ...
            _getPlanList() {
                getdepList(this.postObj).then(res => {
                    if (res.code === '0000') {
                        this.textareaVaule = res.result.result[0].precaution
                    }
                })
            },
            goOn() {
                ...
                var pObj = {
                    _id: this.id,
                    precaution: this.textareaVaule
                }
                updateDep(pObj).then(res => {
                    if (res.code === '0000') {
                        this.$router.push('/home/threeBusiness/er_plan/security')
