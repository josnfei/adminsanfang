        ...
        methods: {
            ...
            _getPlanList() {
				getdepList(this.postObj).then(res => {
					if (res.code === '0000') {
                        this.textareaVaule = res.result.result[0].safeguard
					}
				})
            },
            goOn(){
                ...
                var pObj = {
                    _id: this.id,
                    safeguard: this.textareaVaule
                }
                updateDep(pObj).then(res => {
                    if (res.code === '0000') {
                        this.$router.push('/home/threeBusiness/er_plan/er_action')
