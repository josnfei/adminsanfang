		...
		<div class="edit">
			<div class="title">
				...
				<Breadcrumb separator=">">
					...
					<BreadcrumbItem>
						<a href="javascript:;" @click='cancel'>户外立式广告牌数据</a>
					</BreadcrumbItem>
					...
					<table class="ed-table">
						<tbody>
							...
							<tr>
								...
								<td class="ed-label">抗风级别</td>
								<td class="ed-content">
									<FormItem label="" prop="抗风级别" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.抗风级别"></Input>
									</FormItem>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="ed-label">面积(m²)</td>
								<td class="ed-content">
									<FormItem label="" prop="面积(m²)" style="margin: 0">
										<Input placeholder="请输入姓名" style="width:80%" v-model="formItem['面积(m²)']"></Input>
									</FormItem>
								</td>
								<td class="ed-label">高度(m)</td>
								<td class="ed-content">
									<FormItem label="" prop="高度(m)" style="margin: 0">
										<Input placeholder="请输入单位" style="width:80%" v-model="formItem['高度(m)']"></Input>
									</FormItem>
								</td>
							...
							<tr>
								...
								<td class="ed-content" colspan="5">
									<FormItem label="" prop="管理单位负责人职务" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.职务"></Input>
									</FormItem>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="ed-content" colspan="5">
									<FormItem label="" prop="联系电话" style="margin: 0">
										<Input placeholder="请输入姓名" style="width:80%" v-model="formItem.联系电话"></Input>
									</FormItem>
								</td>
							</tr>
							<tr>
...
<script>
	...
	export default {
		...
		methods: {
			...
			cancel() {
				this.$router.push('/home/depManagement/waitandi')
			},
			//表格显示
			_getuserlist(search) {
				search = {
