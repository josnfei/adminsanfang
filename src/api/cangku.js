...
export function getUserList(page = 1, search = {}) {
	let url = 'dp/supplies_warehouse_info/list'
...
export function getaddlist(obj) {
	let url = 'dp/supplies_warehouse_info/new'
...
export function geteditlist(obj) {
	let url = 'dp/supplies_warehouse_info/edit'
...
export function getdellist(ids) {
	let url = 'dp/supplies_warehouse_info/delete'
