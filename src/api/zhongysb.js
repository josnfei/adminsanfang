...
export function getUserList(page = 1, search = {}) {
	let url = 'dp/communication_facility/list'
...
export function getaddlist(obj) {
	let url = 'dp/communication_facility/new'
...
export function geteditlist(obj) {
	let url = 'dp/communication_facility/edit'
...
export function getdellist(ids) {
	let url = 'dp/communication_facility/delete'
